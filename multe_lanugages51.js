...
title1.innerHTML="coder sif";
Welcome.innerHTML="Welcome to website of coder sif";
about.innerHTML=" About US";
abouttext.innerHTML="I am a teacher and a software Developer";
contact.innerHTML="contact us";

}else if(getlanugage==="arabic"){
title1.innerHTML="المبرمج سيف";
Welcome.innerHTML="مرحبا بكم في صفحه المبرمج سيف";
